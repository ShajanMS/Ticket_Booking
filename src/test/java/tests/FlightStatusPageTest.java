...
public class FlightStatusPageTest extends BaseTest {
	...
	public void testFlightPage() throws InterruptedException {
		...
		flightStatusPage.setHyderabad();

		Thread.sleep(3000);

		driver.findElement(By.xpath("//input[@class='css-1cwyjr8 r-homxoj r-1i10wst r-1eimq0t r-mk0yit r-xfkzu9 r-lnhwgy']")).sendKeys("322");
		...
		Assert.assertEquals(str,"https://www.spicejet.com/flight-status/results?dateLabel=Today&source=MAA&destination=HYD");
	}
